object PrintCashPayoutReportForm: TPrintCashPayoutReportForm
  Left = 356
  Top = 244
  Width = 265
  Height = 161
  ...
  object Report: TppReport
    ...
    object ppSummaryBand: TppSummaryBand
      ...
      mmHeight = 5556
      mmPrintPosition = 0
      object TotalCashPayOut: TppDBCalc
        UserName = 'TotalCashPayOut'
        DataField = 'Amount'
        DataPipeline = ppDBPipeline
        DisplayFormat = '$,0.#0'
        Font.Charset = ANSI_CHARSET
  ...
  object ppDBPipeline: TppDBPipeline
    DataSource = PayOutListForm.DataSource
