...
type
  TPrintInvoiceForm3 = class(TDataModule)
    Query: TADOQuery;
...
var
  PrintInvoiceForm3: TPrintInvoiceForm3;
...
procedure TPrintInvoiceForm3.OpenQuery(SQLStr: String);
begin
...
procedure TPrintInvoiceForm3.PrintOutPro;
var
 TxtFile: TextFile;
...
begin
 ...
 SQLStr := 'Select OrderI.ItemCode, Qty, OrderI.Price, OrderI.Discount, Description1, ' +
           ...
           'SubDescription1, SubDescription2, SubDescription3, Multiple, Scalable ' +
    ...
    begin
     while Not Query.EOF do
      begin
       ...
       if Query.FieldByName('Scalable').AsBoolean then
...
procedure TPrintInvoiceForm3.PrintInvoicePro(OrderNo: string);
begin
 Application.CreateForm(TPrintInvoiceForm3, PrintInvoiceForm3);
 PrintInvoiceForm3.OrderNo := OrderNo;
 PrintInvoiceForm3.PrintOutPro;
 PrintInvoiceForm3.Free;
end;
