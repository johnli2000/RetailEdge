object InstructionLinkForm: TInstructionLinkForm
  Left = 262
  Top = 86
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'Instruction Link'
  ClientHeight = 541
  ClientWidth = 814
  Color = 15389375
  Ctl3D = False
  ...
  object QtyButton: TXiButton
    ...
    ParentFont = False
    TabOrder = 7
    OnClick = QtyButtonClick
  end
  object PriceButton: TXiButton
    Left = 402
    Top = 476
    Width = 90
    Height = 40
  ...
  object NotesLabel: TStaticText
    ...
    AutoSize = False
    Caption = 
      '* If the item with *, the system will automatic selet maximun ch' +
      'arge from selected items.'
    TabOrder = 12
  end
