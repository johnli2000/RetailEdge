...
type
  ...
  TPrintJobListForm5 = class(TDataModule)
...
var
  PrintJobListForm5: TPrintJobListForm5;
...
procedure TPrintJobListForm5.InitBuff;
var
 I: integer;
begin
 for I := 1 to 500 do
...
procedure TPrintJobListForm5.InsertLine(RecordNo: integer);
var
 I: integer;
begin
...
function TPrintJobListForm5.FindIDNo(IDNo: integer): integer;
var
 I: integer;
begin
 I := 1;
...
function TPrintJobListForm5.PostDataToBuff: integer;
var
 I, K, IDNo: integer;
...
procedure TPrintJobListForm5.OpenQuery(SQLStr: String);
begin
...
procedure TPrintJobListForm5.OpenInstructionQuery(SQLStr: String);
begin
 Screen.Cursor := crHourGlass;
 with InstructionQuery do
  begin
...
function TPrintJobListForm5.GetVoidReasonPro(VoidReasonCode: string): string;
var
 SQLStr: string;
begin
...
procedure TPrintJobListForm5.PrintOutPro(PrinterPort: integer);
var
      ...
      begin
       if OrderKindFlag = sTableOrder then
          ...
          if OrderKindFlag = sQuickSale then
             begin
              DataForm.OutPutToPrinter('Quick Service');
...
procedure TPrintJobListForm5.PrintConfirmedOrder;
var
 SQLStr: string;
begin
...
procedure TPrintJobListForm5.PrintUnConfirmedOrder;
var
 SQLStr: string;
begin
 AddNewItem := False;
...
procedure TPrintJobListForm5.PrintJobListPro;
begin
 if ConfirmedOrder then
    PrintConfirmedOrder
   else
...
procedure TPrintJobListForm5.PrintJobList(OrderNo, IDStr: string; PrintAll, ConfirmedOrder: boolean; PrinterPort: integer);
begin
 Application.CreateForm(TPrintJobListForm5, PrintJobListForm5);
 PrintJobListForm5.PrintAll := PrintAll;
 PrintJobListForm5.OrderNo := OrderNo;
 PrintJobListForm5.IDStr := IDStr;
 PrintJobListForm5.ConfirmedOrder := ConfirmedOrder;
 PrintJobListForm5.PrinterPort := PrinterPort;
 PrintJobListForm5.PrintJobListPro;
 PrintJobListForm5.Free;
end;
