object PrintDepositListForm: TPrintDepositListForm
  Left = 356
  Top = 244
  Width = 265
  Height = 161
  ...
  object Report: TppReport
    ...
    object ppSummaryBand: TppSummaryBand
      ...
      mmHeight = 5556
      mmPrintPosition = 0
      object TotalDeposit: TppDBCalc
        UserName = 'TotalDeposit'
        DataField = 'Amount'
        DataPipeline = ppDBPipeline
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
  ...
  object ppDBPipeline: TppDBPipeline
    DataSource = DepositListForm.DataSource
