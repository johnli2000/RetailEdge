...
type
  TPrintOrderForm3 = class(TDataModule)
    Query: TADOQuery;
...
var
  PrintOrderForm3: TPrintOrderForm3;
...
procedure TPrintOrderForm3.OpenQuery(SQLStr: String);
begin
...
procedure TPrintOrderForm3.PrintOutPro;
var
 TxtFile: TextFile;
 ...
 if Query.RecordCount <> 0 then
    begin
     while Not Query.EOF do
      begin
       if (PrintOrderListDescription <> 2) or (Query.FieldByName('Description2').AsString = '') then
...
procedure TPrintOrderForm3.PrintOrderPro(OrderNo: string);
begin
 Application.CreateForm(TPrintOrderForm3, PrintOrderForm3);
 PrintOrderForm3.OrderNo := OrderNo;
 PrintOrderForm3.PrintOutPro;
 PrintOrderForm3.Free;
end;
