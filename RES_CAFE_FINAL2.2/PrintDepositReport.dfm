object PrintDepositReportFrom: TPrintDepositReportFrom
  Left = 517
  Top = 264
  Width = 262
  Height = 197
  ...
  object Report: TppReport
    ...
    object ppSummaryBand1: TppSummaryBand
      ...
      mmHeight = 5556
      mmPrintPosition = 0
      object TotalDepositBalance: TppDBCalc
        UserName = 'TotalDepositBalance'
        DataField = 'Balance'
        DataPipeline = ppDBPipeline
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
  ...
  object ppDBPipeline: TppDBPipeline
    DataSource = DepositReportForm.DataSource
    UserName = 'DBPipeline'
    Left = 18
    Top = 14
