...
type
  ...
  TPrintJobListForm1 = class(TDataModule)
...
var
  PrintJobListForm1: TPrintJobListForm1;
...
procedure TPrintJobListForm1.InitBuff;
var
 I: integer;
begin
 for I := 1 to 500 do
...
procedure TPrintJobListForm1.InsertLine(RecordNo: integer);
var
 I: integer;
begin
...
function TPrintJobListForm1.FindIDNo(IDNo: integer): integer;
var
 I: integer;
begin
 I := 1;
...
function TPrintJobListForm1.PostDataToBuff: integer;
var
 I, K, IDNo: integer;
...
procedure TPrintJobListForm1.OpenQuery(SQLStr: String);
begin
...
procedure TPrintJobListForm1.OpenInstructionQuery(SQLStr: String);
begin
 Screen.Cursor := crHourGlass;
 with InstructionQuery do
  begin
...
function TPrintJobListForm1.GetVoidReasonPro(VoidReasonCode: string): string;
var
 SQLStr: string;
begin
...
procedure TPrintJobListForm1.PrintOutPro(PrinterPort: integer);
var
  ...
  begin
   ...
   if ConfirmedOrder then
      begin
       ...
       if CustomerName <> '' then
                 begin
                  PrintStr := 'Customer: ' + CustomerName;
                  DataForm.OutPutToPrinter(PrintStr);
                 end ;
      end
     else
...
procedure TPrintJobListForm1.PrintConfirmedOrder;
var
 SQLStr: string;
begin
 ...
 if PrintAll then
    SQLStr := 'Select OrderI.ItemCode, Description1, Description2, Condition, Qty, ' +
              ...
              'Null, 0, IDNo, 0, 0, Null, Null, Null, CAST(1 As Bit) ' +
              'From OrderI ' +
...
procedure TPrintJobListForm1.PrintUnConfirmedOrder;
var
 SQLStr: string;
begin
 AddNewItem := False;
...
procedure TPrintJobListForm1.PrintJobListPro;
begin
 if ConfirmedOrder then
    PrintConfirmedOrder
   else
...
procedure TPrintJobListForm1.PrintJobList(OrderNo, IDStr: string; PrintAll, ConfirmedOrder: boolean; PrinterPort: integer);
begin
 Application.CreateForm(TPrintJobListForm1, PrintJobListForm1);
 PrintJobListForm1.PrintAll := PrintAll;
 PrintJobListForm1.OrderNo := OrderNo;
 PrintJobListForm1.IDStr := IDStr;
 PrintJobListForm1.ConfirmedOrder := ConfirmedOrder;
 PrintJobListForm1.PrinterPort := PrinterPort;
 PrintJobListForm1.PrintJobListPro;
 PrintJobListForm1.Free;
end;
