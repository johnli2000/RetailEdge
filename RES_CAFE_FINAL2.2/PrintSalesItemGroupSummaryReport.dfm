object PrintSalesItemGroupSummaryReportForm: TPrintSalesItemGroupSummaryReportForm
  Left = 356
  Top = 244
  Width = 265
  Height = 161
  ...
  object Report: TppReport
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLabel4: TppLabel
        UserName = 'Label4'
        AutoSize = False
        Caption = 'Sales Summary Report (Items Group)'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 18
  ...
  object ppDBPipeline: TppDBPipeline
    DataSource = SalesItemGroupSummaryReportForm.DataSource
    OpenDataSource = False
    UserName = 'DBPipeline'
    Left = 68
    Top = 38
    object ppDBPipelineppField1: TppField
      FieldAlias = 'ItemGroup'
      FieldName = 'ItemGroup'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
