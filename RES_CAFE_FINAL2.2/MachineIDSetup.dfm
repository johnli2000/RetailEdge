object MachineIDSetupForm: TMachineIDSetupForm
  Left = 508
  Top = 213
  BorderIcons = []
  BorderStyle = bsSingle
  Caption = 'Terminal No. Setup'
  ClientHeight = 417
  ClientWidth = 425
  Color = clNone
  ...
  object EditPanel: TbsSkinPanel
    ...
    object MachineIDEdit: TEdit
      ...
      ParentFont = False
      TabOrder = 0
      OnDblClick = MachineIDEditDblClick
      OnKeyPress = MachineIDEditKeyPress
    end
